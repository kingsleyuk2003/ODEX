...
class GeneralReportWizard(models.TransientModel):
    _inherit = 'general.report.wizard'
    ...
    def general_excel_report(self):
        ...
        data['form'] = {'select_per': wiz_data['select_per'],'start_date' : wiz_data['start_date'],'end_date':wiz_data['end_date'],'pfa_ids' : wiz_data['pfa_ids'],'emp_ids' : wiz_data['emp_ids']}
        return {
                     'name':'General Pension Report',
                     'type': 'ir.actions.report.xml',
                    'report_name': 'rog_modifications.report_general_excel_rog',
