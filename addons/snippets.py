...
#../addons/kin_loading/loading.py:2553
precision_digits = self.env['decimal.precision'].precision_get('Product Unit of Measure')
...
# Sending Email Notification
   # ../addons/kin_loading/loading.py:3943
    partn_ids = []
    user_names = ''
...
#../addons/hr_expense/models/hr_expense.py:120
    ...
    def refuse_expenses(self, reason):
        ...
        if self.employee_id.user_id:
            ...
            self.message_post(body=body, partner_ids=[16], subtype='mail.mt_comment')
...
#see ../odoo-11.0/addons/purchase/models/purchase.py:173
    ...
    #../odoo-rebranded-9.0/addons/kin_loading/loading.py:2246
    def sale_order():
