...
# from openerp.addons.report_xlsx.report.report_xlsx import ReportXlsx  #It still works fine as the BalanceSheetReportWriter
from openerp.addons.kin_report.report.balance_sheet_xlsx import  BalanceSheetReportWriter
...
class BalanceSheetReportWriterAgary(BalanceSheetReportWriter):
    ...
    def balance_sheet_xlsx_report(self,workbook, data, objects):
        ...
        account_worksheet.merge_range(2, 0, 2, 3, 'Statement of Financial Position Report', title_format)
...
BalanceSheetReportWriterAgary('report.agary_modifications.report_balance_sheet_agary', 'balance.sheet.parser',parser=report_sxw.rml_parse)
