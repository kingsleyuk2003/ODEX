...
class AccountStandardLedgerReport(models.TransientModel):
    ...
    date_to = fields.Date(string='End Date', help='Use to compute the entries matched with future.')
...
class AccountStandardLedgerLines(models.TransientModel):
    ...
    aml_name = fields.Char(string='Description')
    ...
    age_30_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='0-30d')
    age_60_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='30-60d')
    age_90_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='60-90d')
    age_120_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='90-120d')
...
class AccountStandardLedger(models.TransientModel):
    ...
    name = fields.Char(default='Ledgers')
    type_ledger = fields.Selection([('general', 'General Ledger'), ('partner', 'Partner Ledger'), ('journal', 'Journal Ledger (Journals)'), ('open', 'Open Ledger'), ('aged', 'Aged Balance'), ('analytic', 'Analytic Ledger')], string='Type', default='general', required=True,
                                   help=' * General Ledger Book : Journal entries group by account\n'
    ...
    reconciled = fields.Boolean('With Reconciled Entries', default=True,
                                help='Only for entries with a payable/receivable account.\n'
    ...
    account_methode = fields.Selection([('include', 'Include'), ('exclude', 'Exclude')], string="Method")
    account_in_ex_clude = fields.Many2many(comodel_name='account.account', string='Ledger Accounts', help='If empty, get all accounts')
    ...
    month_selec = fields.Selection([(1, '01 January'), (2, '02 Febuary'), (3, '03 March'), (4, '04 April'), (5, '05 May'), (6, '06 June'),
    ...
    compact_account = fields.Boolean('Summary Account.', default=False)
    report_id = fields.Many2one('account.report.standard.ledger.report')
