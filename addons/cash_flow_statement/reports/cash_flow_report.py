...
# reference: ..addons/account/report/account_report_financial.py:145  From odoo account module
    @api.multi
    def render_html(self, data):
        ...
        return self.env['report'].render('cash_flow_statement.report_financial', docargs)
