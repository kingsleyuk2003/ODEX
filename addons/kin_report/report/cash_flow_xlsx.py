...
class CashFlowReportWriter(ReportXlsx):
    ...
    def cash_flow_xlsx_report(self, workbook, data, objects):
...
CashFlowReportWriter('report.kin_report.report_cash_flow', 'cash.flow.parser',parser=report_sxw.rml_parse)
