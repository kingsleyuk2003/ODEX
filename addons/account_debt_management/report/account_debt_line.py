...
class AccountDebtLine(models.Model):
    ...
    debit = fields.Monetary(currency_field='company_currency_id',string='Debit',compute='_compute_debit')
    credit =   fields.Monetary(currency_field='company_currency_id',string='Credit',compute='_compute_credit')
    ...
    am_name = fields.Char(string="Account Move Name")
    ...
    def init(self, cr):
        ...
        query = """
            ...
            GROUP BY
                ...
                a.internal_type, a.user_type_id, c.document_number,label,am_name,
