...
class EPCCOSReportWizard(models.TransientModel):
    _name = 'epccos.report.wizard'
    ...
    def epccos_excel_report(self):
        ...
        return {
                    ...
                    'report_name': 'rog_modifications.report_epccos_excel_rog',
                    'datas': data, #It is required you use datas as parameter, otherwise it will transfer data correctly.
                    }

    start_date = fields.Date('Start Date')
    end_date = fields.Date('End Date')
    pfa_ids = fields.Many2many('hr.pfa', 'hr_pfa_report_epccos_rel', 'pfawizard_id', 'hr_pfa_id', string='PFAs')
