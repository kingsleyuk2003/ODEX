...
class HRPayslipReport(models.AbstractModel):
    _name = 'report.aminata_modifications.report_payslip_custom_aminata'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('aminata_modifications.report_payslip_custom_aminata')
        ...
        return report_obj.render('aminata_modifications.report_payslip_custom_aminata', docargs)
