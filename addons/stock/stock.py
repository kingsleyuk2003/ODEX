...
class stock_picking(models.Model):
    ...
    def _create_extra_moves(self, cr, uid, picking, context=None):
        ...
        if picking.state == 'done' :
            raise UserError(_('Sorry, the picking document is already in done state. Please refresh your browser'))

        if picking.state == 'cancel' :
            raise UserError(_('Sorry, the picking document is already in cancelled state. Please refresh your browser'))
                ...
                if product_qty < move['product_qty']:
                    warning.update({
                        ...
                        'message': _("By changing this quantity here, you accept the "
                                "new quantity as complete: the system will not "
...
class stock_warehouse_orderpoint(osv.osv):
    ...
    _columns = {
        ...
        'product_min_qty': fields.float('Minimum Quantity', required=True,
            ...
            help="When the virtual stock goes below the Min Quantity specified for this field, the System generates "\
            "a procurement to bring the forecasted quantity to the Max Quantity."),
        'product_max_qty': fields.float('Maximum Quantity', required=True,
            digits_compute=dp.get_precision('Product Unit of Measure'),
            help="When the virtual stock goes below the Min Quantity, the system generates "\
