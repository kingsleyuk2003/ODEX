...
class SalesSummaryReportWizard(models.TransientModel):
    _name = 'sales.summary.report.wizard'
    ...
    @api.multi
    def sales_summary_excel_report(self):
        ...
        return {
                    'name': 'MANAGEMENT REPORT-SUMMARY OF SALES BY PRODUCTS' + " (" + date_str + ")",
                    'type': 'ir.actions.report.xml',
                    'report_name': 'rog_modifications.sales_summary_excel_report_rog',
    ...
    product_ids = fields.Many2many('product.product', 'sales_summary_report_product_rel', 'sales_summary_wizard_id', 'prod_id', string='Products')
