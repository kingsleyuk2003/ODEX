...
# from openerp.addons.report_xlsx.report.report_xlsx import ReportXlsx  #It still works fine as the IncomeStatementReportWriter
from openerp.addons.kin_report.report.income_statement_xlsx import  IncomeStatementReportWriter
...
class IncomeStatementReportWriterAgary(IncomeStatementReportWriter):
...
IncomeStatementReportWriterAgary('report.agary_modifications.report_income_statement_agary', 'income.statement.parser',parser=report_sxw.rml_parse)
