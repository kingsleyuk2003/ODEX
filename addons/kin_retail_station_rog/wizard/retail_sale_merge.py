...
class RetailSaleMergeWizard(models.TransientModel):
    ...
    def action_merge(self):
        ...
        action = self.env['ir.model.data'].xmlid_to_object('kin_retail_station_rog.action_kin_stock_control_form')
        form_view_id = model_data_obj.xmlid_to_res_id('kin_retail_station_rog.view_stock_control_form')
        return {
            'name': action.name,
            'help': action.help,
            'type': action.type,
