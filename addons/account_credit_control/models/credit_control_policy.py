...
class CreditControlPolicyLevel(models.Model):
    ...
    is_penalize = fields.Boolean('Penalize based on Due Balance')
    product_id = fields.Many2one('product.product','Penalize Product')
    penalize_percentage = fields.Float('Percentage (%)')
    is_auto_validate_invoice = fields.Boolean('Auto Validate Penalty Invoice')
...
class AccountInvoice(models.Model):
    ...
    is_pen_invoice = fields.Boolean(string='Penalty Invoice')