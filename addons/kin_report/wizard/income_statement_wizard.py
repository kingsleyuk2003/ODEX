...
class IncomeStatementWizard(models.TransientModel):
    ...
    def income_statement_report(self):
        ...
        data = {'name': 'Income Statement Report', 'active_ids': context.get('active_ids', [])}
        ...
        return {
                    ...
                    'report_name': 'kin_report.report_income_statement',
    ...
    operating_unit_ids = fields.Many2many('operating.unit', 'operating_unit__income_statement_rel', 'financialwizard_id', 'operateunit_id', string='Operating Units')
    journal_ids = fields.Many2many('account.journal','journal_income_statement_rel','financialwizard_id','journalid',string='Journals', default = lambda self : self.env['account.journal'].search([]))
