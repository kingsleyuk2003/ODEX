...
class KinStockControlWriter(ReportXlsx):
    ...
    def _get_data(self,form):
        ...
        if not retail_station_ids :
            retail_station_obj = self.env['kin.retail.station.general'].search([])
...
KinStockControlWriter('report.kin_retail_station_general.stock_control_report','kin.stock.control.wizard',parser=report_sxw.rml_parse)
