    ...
    def compute_sheet(self, cr, uid, ids, context=None):
        ...
        for emp in emp_pool.browse(cr, uid, data['employee_ids'], context=context):
            ...
            res = {
                ...
                'hr_pfa_id': emp.pfa_id.id,
                'function_id': emp.function_id.id,
                'location_id': emp.location_id.id,
                'mgt_non_mgt': emp.mgt_non_mgt,
                'band_id': emp.band_id.id,
                'grade_id': emp.grade_id.id,
                'hr_department_id': emp.hr_department_id.id,
                'sbu_id': emp.sbu_id.id,
                'is_ssd_sbu': emp.is_ssd_sbu,
            }
