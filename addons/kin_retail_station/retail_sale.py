...
class RetailSaleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        user_ids = []
        group_obj = self.env.ref('kin_retail_station.group_retail_sale_order_customer')
    ...
    def unlink(self):
        for rec in self:
            if rec.state == 'sale' and not self.env.user.has_group('kin_retail_station.group_retail_manager'):
...
class RetailStationCustomer(models.Model):
    ...
    def action_view_order(self):
        ...
        action = imd.xmlid_to_object('kin_retail_station.action_private_orders')
        list_view_id = imd.xmlid_to_res_id('kin_retail_station.view_private_order_tree')
        form_view_id = imd.xmlid_to_res_id('kin_retail_station.view_private_order_form')
    ...
    is_enforce_credit_limit_so = fields.Boolean(string='Enforce Credit Limit on Retail Sales Order')
