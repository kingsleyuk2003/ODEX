...
#
# class ReportPartnerLedgerExtend(models.AbstractModel):
...
#         if  partner_ids:
#             str_partners = ""
#             for partn in partner_ids:
#                 str_partners += str(partn) + ","
#             str_partners = "%s%s%s" %('(',str_partners.rstrip(","),')')
#
#             query = """
...
#                 AND "account_move_line".partner_id IN """+ str_partners +"""
