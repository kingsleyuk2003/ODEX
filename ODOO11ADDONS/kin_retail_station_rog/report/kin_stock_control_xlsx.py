...
class KinStockControlWriter(models.AbstractModel):
    _name = 'report.kin_retail_station_rog.stock_control_report'
    _inherit = 'report.report_xlsx.abstract'

    def _get_data(self,objects):
        start_date = objects.start_date
        end_date = objects.end_date
        retail_station_ids = objects.retail_station_ids.ids
